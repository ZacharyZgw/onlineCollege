    ...
    public void batchAdd(List<CourseSectionVO> courseSections) {
        if (CollectionUtils.isNotEmpty(courseSections)){
            ...
            for (int i = 0; i <courseSections.size() ; i++) {
                ...
                //创建章
                this.courseSectionService.createSelectivity(courseSection);
                ...
                if (CollectionUtils.isNotEmpty(subCourseSections)){
                    ...
                    //批量创建 节
                    this.courseSectionService.createList(subCourseSections);

                    //更新时间
                    courseSection.setTime(totalTime);
                    this.courseSectionService.updateSelectivity(courseSection);
                }
